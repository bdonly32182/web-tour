...
export default class JoinUs extends Component {
      ...
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul className="nav navbar-nav navbar-right">
            ...
            <li className="active"><a href="/join">Join with US</a></li>
    ...
    <div className="container">
      ...
      <div className="row custom-table">
        <div className="grid-50 table-cell">
          ...
          <a href="#" className="btn btn-default custom-button border-radius">
            PURCHASE
          </a>
        </div>
        <div className="grid-50 table-cell">
          <img src="assets/images/features-bg.png" alt className="features-img img-responsive _pos-abs" />
        </div>
      </div> {/* /.row */}
    </div> {/* /.container */}
  </section> {/* /.features */}
  ...
  <section className="section-wrapper services-owl">
    <div className="container">
      <div className="owl-carousel services-owl-carousel row">
        <div className="item col-sm-8 col-sm-offset-2">
